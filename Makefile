...
verifier-tests:
	...
	uv run --all-packages pytest tests/test_release_preflight.py tests/test_fetch_runtime_release.py tests/test_run_runtime_builder.py tests/test_build_release_bundle.py tests/test_release_installer.py tests/test_release_upgrade_matrix.py tests/test_release_dispatcher.py tests/test_release_transition_probe.py tests/test_release_wrapper.py -q --cov=scripts.release_preflight --cov=scripts.fetch_runtime_release --cov=scripts.run_runtime_builder --cov=scripts.build_release_bundle --cov=scripts.release_upgrade_matrix --cov=scripts.release_transition_probe --cov-branch --cov-append --cov-report=term-missing --cov-report=xml --cov-fail-under=90
