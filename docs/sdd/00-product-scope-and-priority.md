...
| --- | --- |
| API Catalog | API document asset management only: upload / list / details / delete. P2-00 activates only that documentation-asset surface through `docs/sdd/adr/ADR-0010-p2-api-catalog-scalar.md` and `docs/sdd/slices/P2-00-api-catalog-scalar.md`. |
