...
| [ADR-0016](ADR-0016-p2-help-ai-agents-system-openapi-bootstrap.md) | P2 Help AI Agents and System OpenAPI Bootstrap | Accepted | Authenticated Help AI Agents guidance, Public API AI skill source download, and system OpenAPI first-Admin creation plus bounded startup reconciliation |
...
| [ADR-0029](ADR-0029-user-local-release-upgrade.md) | User-local Release Upgrade Transition | Accepted | Exact-target installed-release transition and recovery protocol |
