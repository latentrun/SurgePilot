...
The current delivery target is **P2-02 Public API Substrate and governed Public API AI skill source package implementation plus P2-03 Env Group Secret implementation**. P2 work may start only when a task names the active P2 Slice SDD and its accepted ADR. The active P2 surfaces are:
