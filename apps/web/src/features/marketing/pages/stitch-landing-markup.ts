...
<nav class="sticky top-0 z-50 w-full h-16 flex items-center justify-between px-4 md:px-8 bg-[#0a0e1a]/80 backdrop-blur-md border-b border-white/5">
  ...
  <div class="flex items-center gap-3 md:gap-4">
    ...
    <a class="text-sm text-on-surface/60 hover:text-primary transition-all px-3 md:px-4 py-2" href="/login">Log in</a>
    <a class="text-sm bg-primary text-[#00363e] px-4 md:px-5 py-2 rounded font-bold primary-glow-btn transition-all" href="/register">Sign up</a>
  </div>
</nav>
...
<header class="relative min-h-[90vh] flex flex-col items-center justify-start pt-16 px-6">
  <div class="max-w-4xl text-center z-10 mb-16">
    ...
    <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
      <a class="w-full sm:w-auto bg-primary text-[#00363e] px-8 py-4 rounded-lg font-bold primary-glow-btn text-lg" href="/register">Get started</a>
...
<section class="py-12 max-w-6xl mx-auto px-6 relative">
  <div class="glass-card rounded-xl border border-white/10 overflow-hidden">
    <div class="px-6 py-4 border-b border-white/5 bg-white/5 flex items-center justify-between"><h2 class="font-technical text-xs uppercase tracking-widest text-primary">Recent Test Runs</h2><span class="font-technical text-[10px] text-primary border border-primary/20 bg-primary/10 rounded-full px-3 py-1">UI DEMONSTRATION · NOT BENCHMARK DATA · EXAMPLE DATA · NOT A LIVE SERVICE · LIVE_UPDATE: ON</span></div>
...
<section class="py-24 px-6 mb-20">
  <div class="max-w-6xl mx-auto relative overflow-hidden glass-card rounded-[2.5rem] p-10 md:p-16 text-center border border-white/10">
    <div class="relative z-10"><h2 class="text-4xl md:text-6xl font-bold font-display mb-8 tracking-tight">Inspect the baseline. <br/><span class="text-primary">Then judge the claim.</span></h2><div class="flex flex-col sm:flex-row items-center justify-center gap-6"><a class="w-full sm:w-auto bg-primary text-[#00363e] px-12 py-5 rounded-xl font-bold primary-glow-btn text-xl" href="/register">Get started now</a><a class="w-full sm:w-auto border border-white/10 text-on-surface-variant px-12 py-5 rounded-xl backdrop-blur-xl flex items-center justify-center gap-3 hover:border-primary/40 hover:text-primary transition-colors" href="__SURGEPILOT_REPOSITORY__"><svg class="w-6 h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M4 5a2 2 0 012-2h9l5 5v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>View on GitHub</a></div><p class="mt-10 font-technical text-on-surface-variant/60 text-xs uppercase tracking-[0.3em]">Open Source • MIT License • Self-Hosted</p></div>
  </div>
</section>
...
<footer class="bg-[#0a0e1a] border-t border-white/5 pt-24 pb-12 px-6">
  <div class="max-w-7xl mx-auto"><div class="grid grid-cols-2 md:grid-cols-6 gap-12">
    ...
    <div><h3 class="font-technical text-primary text-[10px] uppercase tracking-widest mb-6">Project</h3><ul class="space-y-4 text-sm"><li><a class="text-on-surface-variant hover:text-on-surface transition-colors" href="__SURGEPILOT_REPOSITORY__">GitHub</a></li><li><a class="text-on-surface-variant hover:text-on-surface transition-colors" href="__SURGEPILOT_RELEASES__">Releases</a></li><li><span aria-disabled="true" class="text-on-surface-variant hover:text-on-surface transition-colors marketing-disabled-inline">Security</span></li></ul></div>
  </div></div>
</footer>

`;

export const STITCH_LANDING_LINKS = Object.freeze({
...
export function getStitchLandingMarkup(logoUrl: string) {
  const repository = STITCH_LANDING_LINKS.repository;
  return stitchLandingMarkup
    .replaceAll("__SURGEPILOT_LOGO__", logoUrl)
    .replaceAll("__SURGEPILOT_DOCS__", STITCH_LANDING_LINKS.docs)
    .replaceAll(
      "__SURGEPILOT_QUICKSTART__",
      `${STITCH_LANDING_LINKS.docs}quickstart`,
    )
    .replaceAll(
      "__SURGEPILOT_CONFIGURATION__",
      `${STITCH_LANDING_LINKS.docs}configuration`,
    )
    .replaceAll("__SURGEPILOT_REPOSITORY__", repository)
    .replaceAll("__SURGEPILOT_RELEASES__", STITCH_LANDING_LINKS.releases)
