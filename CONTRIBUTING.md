...
Source contributors need Git, GNU or compatible Make, a POSIX shell, Perl, `curl`, `tar`/gzip, and
a SHA-256 utility. Docker and Docker Compose v2 are additionally required for full-stack and E2E
